...
LOGGING = {
    ...
    "formatters": {
        "ecs_formatter": {"()": MMDECSFormatter},
        "plaintext": {
            "format": "%(levelname)s %(asctime)s [%(correlation_id)s] %(name)s %(message)s"
        },
    },
    "filters": {
        "require_local_false": {"()": "core.log_filter.RequireLocalFalse"},
        "require_local_true": {"()": "core.log_filter.RequireLocalTrue"},
        "require_dev_false": {"()": "core.log_filter.RequireDevFalse"},
        "require_dev_true": {"()": "core.log_filter.RequireDevTrue"},
        "require_beta_true": {"()": "core.log_filter.RequireBetaTrue"},
        "require_prod_true": {"()": "core.log_filter.RequireProdTrue"},
        "require_test_false": {"()": "core.log_filter.RequireTestingFalse"},
        "require_test_true": {"()": "core.log_filter.RequireTestingTrue"},
        "correlation_id": {"()": "django_guid.log_filters.CorrelationId"},
        "skip_logging_path": {"()": "core.log_filter.SkipLoggingPath"},
    },
    "handlers": {
