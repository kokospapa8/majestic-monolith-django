...
urlpatterns = [
    # transport
    path(
        "transports/<uuid:uuid>/batches/",
        TransportBatchesView.as_view(),
        name="transport_batches",
    ),
    path(
        "transports/<uuid:uuid>/add/",
        TransportBatchesAddView.as_view(),
        name="transport_batches_add",
    ),
    path(
        "transports/<uuid:uuid>/start/",
        TransportStartView.as_view(),
        name="transport_batches_start",
    ),
    path(
        "transports/<uuid:uuid>/complete/",
        TransportCompleteView.as_view(),
        name="transport_batches_complete",
    ),
    # batches
    path(
        "batches/<str:alias>/shippingitems/",
        BatchShippingitemsView.as_view(),
        name="batch_shippingitems",
    ),
    path(
        "batches/<str:alias>/add/",
        BatchShippingitemsAddView.as_view(),
