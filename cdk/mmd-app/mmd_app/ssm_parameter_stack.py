...
class SsmParameterStack(cdk.NestedStack):
    def __init__(self, scope: Construct, construct_id: str, config, **kwargs) -> None:
        ...
        # Get DB Password
        ssm_db_password = ssm.StringParameter.value_for_string_parameter(
            self, "/infraTest/DB_PASSWORD"
        )
        ssm_db_password_interface = ssm.StringParameter.from_string_parameter_name(
            self, "ssm_db_password_interface", string_parameter_name="/infraTest/DB_PASSWORD"
        )
        ...
        # Get DB Host
        ssm_db_host = ssm.StringParameter.value_for_string_parameter(
        ...
        # Get S3 Bucket
        ssm_s3 = ssm.StringParameter.value_for_string_parameter(
        ...
        ssm_django_secret = ssm.StringParameter.value_for_string_parameter(
            self, "/infraTest/SECRET_KEY"
        )
        ssm_django_secret_interface = ssm.StringParameter.from_string_parameter_name(
            self, "ssm_django_secret_interface", string_parameter_name="/infraTest/SECRET_KEY"
        )
        ...
        # Get AWS AccessKey
        ssm_aws_access = ssm.StringParameter.value_for_string_parameter(
        ...
        # Get AWS SecretKey
        ssm_aws_secret = ssm.StringParameter.value_for_string_parameter(
        ...
        # Get Redis Host
        ssm_redis_host = ssm.StringParameter.value_for_string_parameter(
