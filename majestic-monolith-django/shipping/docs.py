...
from core.docs import dict_response_schema, list_response_schema, param
...
doc_transport_batches = swagger_auto_schema(
    ...
    manual_parameters=[
        param(
            "ordering",
            "timestamp_created, timestamp_completed, -timestamp_created, -timestamp_completed",
        ),
        param("completed", "1, 0"),
    ],
    tags=["shipping"],
    responses={
        200: dict_response_schema(list_response_schema(shipping_batch_response)),
    },
)
...
doc_batch_items = swagger_auto_schema(
    ...
    tags=["shipping"],
    responses={
        200: dict_response_schema(list_response_schema(shipping_items_response))
    },
)
