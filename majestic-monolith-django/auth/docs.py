...
doc_auth_singin = swagger_auto_schema(
    ...
    tags=["auth signin"],
    responses={200: "signin successful", 400: "invalid credential \n"},
)
...
doc_auth_singin_token_confirm = swagger_auto_schema(
    ...
    tags=["auth signin"],
    responses={
        200: dict_response_schema({"refresh": "", "token": ""}),
...
doc_auth_signout = swagger_auto_schema(
    ...
    responses={204: "sign out completed"},
)
